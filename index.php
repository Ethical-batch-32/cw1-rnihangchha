...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="C:\xamppp\htdocs\gym\img\310307" alt="Logo" /></h3></div>
            ...
            ?>
            <div class="form-actions center">
            <a href="customer/index.php"><button type="submit" class="btn btn-secondary btn-lg btn-block" title="Log In" name="login" value="customer">Customer Login</button></a>
            </div>
